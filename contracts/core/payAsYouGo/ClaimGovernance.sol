...
contract ClaimGovernance is IClaimGovernance, BaseUpgradeablePausable {
    ...
    function _createClaim(
        ...
        bool isClaimRegistered = _registerClaimInfo(addressUser, categoryID, subcategoryID, proof, requestedClaimAmount);
        if(!isClaimRegistered) {
            revert ClaimGovernance__ClaimUnregisteredError();
        }
